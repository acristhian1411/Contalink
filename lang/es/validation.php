...
return [
    ...
    */
    ...
    'custom' => [
        'proofPayments' => [
            'required' => 'Debe seleccionar al menos un tipo de pago.',
    ...
    */
    ...
    'attributes' => [
        ...
        'city_code' => 'Código',
        'state_name' => 'Nombre',
        'iva_type_desc' => 'Descripción',
        'iva_type_percent' => 'Porcentaje',
        'person_fname' => 'Nombre',
        'person_lastname' => 'Apellido',
        'person_corpname' => 'Razon social',
        'person_idnumber' => 'Cedula',
        'person_ruc' => 'RUC',
        'person_photo' => 'Foto',
        'person_birtdate' => 'Fecha de nacimiento',
        'person_address' => 'Direccion',
        'p_type_id' => 'Tipo de persona',
        'country_id' => 'Pais',
        'city_id' => 'Ciudad',
        'p_type_desc' => 'Descripción',
        'product_name' => 'Nombre del producto',
        'product_desc' => 'Descripción del producto',
        'product_cost_price' => 'Precio de costo',
        'product_selling_price' => 'Precio de venta',
        'category_id' => 'Categoria',
        'iva_type_id' => 'Tipo de IVA',
        'proof_payment_desc' => 'Comprobantes',
        'payment_type_id' => 'Forma de pago',
        'person_id' => 'Persona',
        'purchase_desc' => 'Descripción',
        'purchase_date' => 'Fecha de compra',
        'purchase_number' => 'Numero de compra',
        'purchase_status' => 'Estado de la compra',
        'purchase_type' => 'Tipo de compra',
        'till_name' => 'Nombre',
        't_type_id' => 'Tipo de caja',
        'till_status' => 'Estado de la caja',
        'till_account_number' => 'Numero de cuenta',
